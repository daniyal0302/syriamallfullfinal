  ...
  return (
    <nav className="sticky top-0 z-50 bg-background border-b border-border">
      <div className="container mx-auto px-4">
              ...
              <NavLink to="/become-vendor">
                <Button variant="ghost" size="sm" className="hidden md:flex items-center gap-2 text-primary hover:text-primary hover:bg-primary/10">
                  ...
                  {/* <span className="font-medium">Vendor Enrollment</span> */}
                   <span className="font-medium">{t('nav.vendorEnrollment')}</span>
                </Button>
              </NavLink>
            )}
              ...
              <DropdownMenuContent align="end" className="w-48">
                {!user ? (
                  <>
                    ...
                    <DropdownMenuItem asChild>
                      <NavLink to="/auth">{t('nav.signUp')}</NavLink>
                    </DropdownMenuItem>
                  </>
                ) : (
                  <>
                    ...
                    {role === 'vendor' && (
                      <DropdownMenuItem asChild>
                        <NavLink to="/vendor">{t('nav.vendorDashboard')}</NavLink>
                      </DropdownMenuItem>
                    )}
                    {role === 'admin' && (
                      <DropdownMenuItem asChild>
        ...
        {/* Categories */}
        <div className="hidden lg:flex items-center gap-6 h-12 border-t border-border">
          <NavLink
            to="/category/electronics"
            className="text-sm font-medium hover:text-primary transition-colors"
          >
