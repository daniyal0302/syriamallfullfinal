...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (passwords.newPassword !== passwords.confirmPassword) {
      toast({ title: t('common.error'), description: t('resetPassword.passwordsNoMatch'), variant: "destructive" });
      return;
    }
    ...
    try {
      ...
      setPasswordReset(true);
      toast({ title: t('common.success'), description: t('resetPassword.passwordResetSuccess') });
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-heading font-bold">{t('resetPassword.title')}</CardTitle>
          ...
          <CardContent>
            {passwordReset ? (
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold">{t('resetPassword.success')}</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  <div className="flex gap-2 items-start">
                    <Lock className="h-5 w-5 text-muted-foreground mt-0.5" />
                    <div className="text-sm text-muted-foreground space-y-1">
                      <p className="font-medium text-foreground">{t('resetPassword.requirements')}</p>
                      <ul className="list-disc list-inside space-y-1">
