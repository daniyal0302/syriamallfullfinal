...
const Careers = () => {
  ...
  const defaultJobs = [
    { id: "1", titleKey: "seniorFrontend", descKey: "seniorFrontendDesc", deptKey: "engineering", locationKey: "remote", typeKey: "fullTime" },
    { id: "2", titleKey: "productManager", descKey: "productManagerDesc", deptKey: "product", locationKey: "damascus", typeKey: "fullTime" },
    { id: "3", titleKey: "customerSupport", descKey: "customerSupportDesc", deptKey: "customerService", locationKey: "remote", typeKey: "fullTime" },
    { id: "4", titleKey: "marketingManager", descKey: "marketingManagerDesc", deptKey: "marketing", locationKey: "damascus", typeKey: "fullTime" },
    { id: "5", titleKey: "vendorRelations", descKey: "vendorRelationsDesc", deptKey: "operations", locationKey: "remote", typeKey: "fullTime" },
  ];
        ...
        <section className="py-16 container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground">{t('careers.growthDesc')}</p>
              </CardContent>
            </Card>
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle>{t('careers.workLifeBalance')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">{t('careers.workLifeDesc')}</p>
              </CardContent>
            </Card>
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle>{t('careers.inclusiveCulture')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">{t('careers.inclusiveDesc')}</p>
              </CardContent>
            </Card>
          </div>
        </section>
              ...
              {defaultJobs.map((job) => (
                <Card key={job.id} className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div className="flex-1">
                        <h3 className="text-xl font-semibold mb-2">{t(`careers.${job.titleKey}`)}</h3>
                        <p className="text-muted-foreground mb-3">{t(`careers.${job.descKey}`)}</p>
                        <div className="flex flex-wrap gap-2">
                          <Badge variant="secondary">{t(`careers.${job.deptKey}`)}</Badge>
                          <Badge variant="outline" className="flex items-center gap-1">
                            <MapPin className="h-3 w-3" />
